...
<body>
  ...
  <div id="usuarios" class="secao-admin">
    ...
    <table>
      <tr>
        <th>ID</th><th>Avatar</th><th>Nome</th><th>Usuário</th><th>Email</th><th>Tipo</th><th>Ações</th>
      </tr>
  ...
  <div id="lixeiras" class="secao-admin" style="display:none;">
    ...
    <table>
      <tr>
        <th>ID</th><th>Nome</th><th>Localização</th><th>Ações</th>
      </tr>
      <?php
  ...
  <div id="depoimentos" class="secao-admin" style="display:none;">
    ...
    <table id="tabela-depoimentos">
      <tr>
        <th>Usuário</th><th>Depoimento</th><th>Data</th><th>Ações</th>
      </tr>
      <?php
      ...
      ?>
        <tr class="dep-row" data-usuario="<?php echo htmlspecialchars($dep['autor']); ?>">
          ...
          <td>
            <a href="admin.php?deleteDep=<?php echo $dep['id']; ?>" onclick="return confirm('Excluir este depoimento?')">Excluir</a>
          </td>
        </tr>
      <?php } ?>
    </table>
